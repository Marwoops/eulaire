    ...
    public void paintComponent(Graphics g) {
        ...
        if (toSolve) {
            ...
            for (int i = 0; i < sol.size() - 1; i++) {
                ((Graphics2D) g).draw(new Ellipse2D.Double(coord.get(sol.get(i)).getX(), coord.get(sol.get(i)).getY(), diam, diam));
                /*try {
                ...
                ((Graphics2D) g).draw(new Ellipse2D.Double(coord.get(sol.get(i+1)).getX(), coord.get(sol.get(i+1)).getY(), diam, diam));
            }
        }
    }
